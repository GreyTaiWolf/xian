...
![V2.0 桌面战斗布局](assets/ui-references/ui-reference-v2-combat-desktop.png)

落地点：左侧角色战力、中央程序化战斗视野、目标 HUD、行动横幅与队列、底部技能/战斗纪要、右侧成长面板。生成图中的人物与地图纹理只作为构图参考，运行时仍由 Canvas 几何绘制。

### 移动端

![V2.0 移动战斗布局](assets/ui-references/ui-reference-v2-combat-mobile.png)

落地点：战斗视野优先、三技能固定操作区、面板抽屉与底部导航、可触控尺寸和安全区适配。
